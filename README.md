# `Packmol_jll.jl` (v20.3.5+0)

[![deps](https://juliahub.com/docs/Packmol_jll/deps.svg)](https://juliahub.com/ui/Packages/Packmol_jll/0j4sv?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/584c9dc3226c36cd45737fc9d6966b0b31cc7d7c/P/Packmol/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `Packmol_jll.jl` have been built from these sources:

* compressed archive: https://github.com/m3g/packmol/archive/refs/tags/v20.3.5.tar.gz (SHA256 checksum: `cde64dbe212ea6569d656f4800af7cba3e40f1492b5e51195b4ce9fc7040c0c0`)

## Platforms

`Packmol_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `Packmol_jll.jl`:
